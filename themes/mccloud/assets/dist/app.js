...
/***/ "./wp-content/themes/mccloud/js/app.js":
/*!*********************************************!*\
  !*** ./wp-content/themes/mccloud/js/app.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header */ "./wp-content/themes/mccloud/js/header.js");
...
window.header = new _header__WEBPACK_IMPORTED_MODULE_0__.Header();

// Set header position when wpadminbar exists
var wpadminbarInterval = setInterval(function () {
...
function wpadminbarHeaderScrollPosition() {
  var offsetTop = $("#wpadminbar").height() - $(window).scrollTop();
  $(".header").css({
...
jQuery(document).ready(function ($) {
  ...
  resource.setAttribute("href", "https://fonts.googleapis.com/css2?family=Manrope:wght@200..800&display=swap");
  ...
  $(".similar-posts-slider").slick({
    mobileFirst: true,
    arrows: true,
    appendArrows: $(".similar-posts-slider-arrows"),
    //$('.clients-slider-dots'),
    responsive: [{
      breakpoint: 1366,
      settings: {
  ...
  $(".footer__collapse .footer__collapse-toggle").click(function (e) {
    $(this).parent().find(".footer__collapsed").toggleClass("footer__collapsed_open");
  });
  $("[data-spinback-usage-image]").click(function () {
    $("[data-spinback-usage-image]").removeClass("border-customlightGray").addClass("border-[#F2F2F7]");
    $(this).removeClass("border-[#F2F2F7]").addClass("border-customlightGray");
    $("[data-spinback-usage-image-preview]").css("background-image", "url(" + $(this).data("spinback-usage-image") + ")");
  });
});
...
$(document).ready(function () {
  ...
  $(".wpcf7-form input").on("focus", function () {
    ...
    var recaptchaKey = "6LcK7voqAAAAALqdQgIVvlGPcDDI-_XxPtNr4xkN";
...
document.addEventListener('DOMContentLoaded', function () {
  if (document.querySelectorAll('.plans-container.active').length == 2) {
    setTimeout(function () {
      document.querySelectorAll('.plans-container.active')[1].classList.remove('active');
    }, 200);
  }
  var togglerItems = document.querySelectorAll('.toggler-item');
  var plansContainers = document.querySelectorAll('.plans-container');

  // Add event listener to each toggler item
  togglerItems.forEach(function (item) {
    item.addEventListener('click', function () {
      // Remove 'button-active' from all toggler items
      togglerItems.forEach(function (el) {
      ...
      plansContainers.forEach(function (container) {
        return container.classList.remove('active');
      });

      // Find the corresponding plan container and add the 'active' class
      var targetContainer = document.querySelector(".plans-container[data-item=\"".concat(target, "\"]"));
      if (targetContainer) {
...
/***/ "./wp-content/themes/mccloud/js/header.js":
/*!************************************************!*\
  !*** ./wp-content/themes/mccloud/js/header.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Header = /*#__PURE__*/function () {
  ...
  return _createClass(Header, [{
    key: "searchOpen",
    value: function searchOpen(selector) {
    ...
    key: "searchInit",
    value: function searchInit(el) {
      var _this = this;
      this.searchInput = $(el);
      var timer = null;
      $(el).off("input").on("input", function () {
        _this.searchValueBefore = _this.searchValue;
        _this.searchValue = $(el).val();
        if (!_this.searchValue) {
          _this.search();
        } else if (_this.searchValueBefore != _this.searchValue) {
          clearTimeout(timer);
      ...
      $(document).mouseup(function (e) {
        var container = $(_this.searchContainer);
    ...
    key: "openMenu",
    value: function openMenu(selector) {
    ...
    value: function toggleMenuMobile() {
      if (this.menuIsOpen) {
        this.closeMenuMobile();
      } else {
        this.openMenuMobile();
...
/***/ "./wp-content/themes/mccloud/sass/app.scss":
/*!*************************************************!*\
  !*** ./wp-content/themes/mccloud/sass/app.scss ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"/wp-content/themes/mccloud/dist/app": 0,
/******/ 			"wp-content/themes/mccloud/dist/app": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmccloud_ua"] = self["webpackChunkmccloud_ua"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["wp-content/themes/mccloud/dist/app"], () => (__webpack_require__("./wp-content/themes/mccloud/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["wp-content/themes/mccloud/dist/app"], () => (__webpack_require__("./wp-content/themes/mccloud/sass/app.scss")))
