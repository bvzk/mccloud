 ...
 *
 * Passes it through the `mccloud_starter_content` filter before returning.
 *
 * @since  Twenty Twenty 1.0.0
 * @return array a filtered array of args for the starter_content.
 */
function mccloud_get_starter_content() {
	 ...
	 */
	return apply_filters( 'mccloud_starter_content', $starter_content );
