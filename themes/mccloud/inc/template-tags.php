 ...
 */
function mccloud_site_logo( $args = array(), $echo = true ) {
 ...
 */
function mccloud_site_description( $echo = true ) {
 ...
 * @return bool
 */
function mccloud_is_comment_by_post_author( $comment = null ) {
 ...
 */
function mccloud_filter_comment_reply_link( $link ) {
 ...
 */
function mccloud_the_post_meta( $post_id = null, $location = 'single-top' ) {
 ...
 */
function mccloud_edit_post_link( $link, $post_id, $text ) {
	if ( is_admin() ) {
		return $link;
	}
 ...
 */
function mccloud_get_post_meta( $post_id = null, $location = 'single-top' ) {
 ...
 */
function mccloud_filter_wp_list_pages_item_classes( $css_class, $item, $depth, $args, $current_page ) {
 ...
 */
function mccloud_add_sub_toggles_to_main_menu( $args, $item, $depth ) {
...
add_filter( 'nav_menu_item_args', 'mccloud_add_sub_toggles_to_main_menu', 10, 3 );
 ...
 */
function mccloud_nav_menu_social_icons( $item_output, $item, $depth, $args ) {
...
add_filter( 'walker_nav_menu_start_el', 'mccloud_nav_menu_social_icons', 10, 4 );
...
add_action( 'wp_head', 'mccloud_no_js_class' );
 ...
 */
function mccloud_body_classes( $classes ) {
	...
	if ( is_page_template( array( 'template-parts/entries/template-cover.php' ) ) ) {
		$classes[] = 'overlay-header';
	}

	// Check whether the current page has full-width content.
	if ( is_page_template( array( 'ttemplate-parts/entries/template-full-width.php' ) ) ) {
...
add_filter( 'body_class', 'mccloud_body_classes' );
 ...
 */
function mccloud_get_the_archive_title( $title ) {
 ...
 */
function mccloud_toggle_duration() {
	/**
 ...
 */
function mccloud_unique_id( $prefix = '' ) {
	static $id_counter = 0;
