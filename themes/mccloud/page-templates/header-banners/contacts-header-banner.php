        ...
        <ul class="flex text-[#8E8E93] justify-center text-[14px]" itemscope itemtype="https://schema.org/BreadcrumbList">
            ...
            <?php if( is_page( 'blog' ) && isset($_GET['term_id']) && $category = get_category_by_slug($_GET['term_id'])) { ?>
                ...
                <li class="truncate" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <span aria-current="page" itemprop="item"><?= $category->name; ?></span>
                    <meta itemprop="position" content="3" />
                </li>
            <?php } else { ?>
                <li class="truncate" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <span aria-current="page" itemprop="item"><?php the_title(); ?></span>
                    <meta itemprop="position" content="2" />
                </li>
            <?php } ?>
        </ul>
...
<div class="container flex flex-col lg:flex-row py-11 2xl:py-[120px]">
    <div class="lg:w-5/12 xl:pr-[144px]">
        <h1 class="title-text-2 mb-6 font-semibold"><?php echo pll__('Контакти компанії'); ?></h1>
        <div class="text-3 mb-6">
            <?php echo pll__('Маєте питання щодо хмарних сервісів? Наша команда доступна з 9:00 до 18:00 у робочі дні.<br>Звертайтеся до нас, адже ми спеціалізуємося на наданні високоякісних послуг у сфері хмарних технологій.'); ?>            
        </div>
        ...
        <div class="flex items-center mb-3">
            ...
            <div class="ml-[41px]">
                ...
                <a href="#"><?php echo pll__('Як дістатися?'); ?></a>
            </div>
        </div>
    </div>
    <div class="lg:w-7/12">
        <div class="text-4 leading-5 font-bold mb-6"><?php echo pll__('Задати питання'); ?></div>
        <?php 
