<div class="xl:py-[120px] lg:py-7 md:py-6 py-5">
    <div class="container flex flex-col-reverse md:flex-row">
        <div class="home-services-helper 2xl:w-1/2 xl:w-7/12 lg:w-5/12 md:w-1/2 z-20 bg-lightgreen 2xl:pr-[152px] xl:pr-[102px] lg:pr-[22px]
                mt-[35px] md:mt-0">
            <div class="badge inline-block border border-orange text-orange font-medium md:mb-4 mb-2">
                Google cloud partner
            </div>
            <h1 class="2xl:text-8 lg:text-5 text-5 2xl:leading-9 lg:leading-6 leading-5 mb-4 2xl:mb-6 font-bold md:text-4 leading-6">
                <?php echo pll__('mcCloud — відчуйте переваги хмарних рішень'); ?>
            </h1>
            <div class="text-3 xl:text-[20px] leading-4 xl:leading-[28px] font-medium mb-6 2xl:mb-7">
                <?php echo pll__('Прем\'єр партнер Google Cloud в Україні. Хмарні рішення Google Cloud для покращення бізнесу.'); ?>
            </div>
            <div class="hidden md:flex flex-col xl:flex-row mb-6 text-3">
                <div class="flex xl:mr-9 xl:mb-0 mb-2">
                    ...
                    <?php echo pll__('Навчання і консалтинг<br>ІТ-персоналу і користувачів'); ?>
                </div>
                <div class="flex">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="mt-1 mr-2">
                    ...
                    <?php echo pll__('Гнучкі, інноваційні рішення<br>для вас та вашої команди'); ?>
                </div>
            </div>
            ...
            <div id="homeServicesSlider" class="slick-home-header">
                <div class="animated-banner mr-3 md:mr-6">
                    ...
                    <div class="animated-banner__layer">
                        <div class="2xl:text-5 2xl:leading-6 xl:text-4 xl:leading-5 font-semibold mb-3">
                            <?php echo pll__('Впровадження<br>хмарних рішень'); ?></div>
                ...
                <div class="animated-banner mr-3 md:mr-6">
                    ...
                    <div class="animated-banner__layer">
                        <div class="2xl:text-5 2xl:leading-6 xl:text-4 xl:leading-5 font-semibold mb-3">
                            <?php echo pll__('Оптимізація<br>процесів'); ?></div>
                        <div class="text-3 leading-4">
                            <?php echo pll__('Оптимізуйте робочий час співробітників та підвищіть їх продуктивність. На рутинні завдання тепер буде витрачатись менше часу.'); ?>                            
                        </div>
                    </div>
                </div>
                <div class="animated-banner mr-3 md:mr-6">
                    ...
                    <div class="animated-banner__layer">
                        <div class="2xl:text-5 2xl:leading-6 xl:text-4 xl:leading-5 font-semibold mb-3">
                            <?php echo pll__('Тренінги та<br>консультації'); ?></div>
                        <div class="text-3 leading-4">
                            <?php echo pll__('Інтегруйте хмарні технології якнайшвидше та без жодного стресу. Вам в допомогу – інформативні та дійсно цікаві тренінги, персональне навчання, зрозумілі інструкції.'); ?>
                        </div>
                    </div>
                </div>
                <div class="animated-banner mr-3 md:mr-6">
                    ...
                    <div class="animated-banner__layer">
                        <div class="2xl:text-5 2xl:leading-6 xl:text-4 xl:leading-5 font-semibold mb-3">
                            <?php echo pll__('Оптимізація<br>бюджету'); ?></div>
                        <div class="text-3 leading-4">
                            <?php echo pll__('Обирайте найвигідніший тариф для вашого бізнесу. З рішеннями від Google ви платите лише за ті сервіси, якими користуєтесь.'); ?>
                        </div>
                    </div>
                </div>
                <div class="animated-banner mr-3 md:mr-6">
                    ...
                    <div class="animated-banner__layer">
                        <div class="2xl:text-5 2xl:leading-6 xl:text-4 xl:leading-5 font-semibold mb-3">
                            <?php echo pll__('Технічна<br>підтримка'); ?></div>
                        <div class="text-3 leading-4">
                            <?php echo pll__('Оперативно вирішуйте будь-яке питання, а також отримуйте корисні рекомендації щодо використання сервісів Google Workspace.'); ?>
                        </div>
                    </div>
                </div>
            </div>
