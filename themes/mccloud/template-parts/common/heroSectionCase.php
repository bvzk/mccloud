...
<div class="max-w-[806px] mx-auto text-center overflow-hidden" style="padding-top: 60px;">
    <nav aria-label="Breadcrumb" class="mb-[18px] md:block" itemscope itemtype="https://schema.org/BreadcrumbList" 1>
        ...
        <ul class="flex text-[#8E8E93] justify-center text-[14px]">
            ...
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" >
                <a href="<?= home_url(); ?>/cases/" class="text-[#8E8E93]" itemprop="item">
...
<div class="xl:py-[120px] lg:py-7 md:py-6 py-5">
    <div class="container flex flex-col-reverse md:flex-row md:items-center">
        <div class="w-full z-20 bg-lightgreen md:pr-7">
            ...
            if (empty($customHtml)) { ?>
                <div class="flex">
                    <a href="<?php echo get_field('header_link') ? get_field('header_link') : '#consultForm'?>" class="btn btn-lg btn-success md:w-auto w-full text-center"><?php echo pll__('Замовити'); ?></a>
                </div>
                <?php
            } else { ?>
                <?php echo $customHtml; ?>
