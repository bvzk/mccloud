<?php
set_query_var('title', 'Залишились питання по тарифах?');
set_query_var('subtitle', ' Наші менеджери допоможуть підібрати оптимальний пакет, нададуть професійну консультацію та відповіді на  ваші питання.');
